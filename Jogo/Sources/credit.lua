...
function scene:create( event )
    ...
    local graphics = display.newImage("imagens/nomeDosDesigns.png",display.actualContentWidth * 0.69, display.actualContentHeight * 0.37)
    local textDesenvolpers = display.newImage("imagens/desenvolvedores.png",display.actualContentWidth * 0.235, display.actualContentHeight * 0.75)
    local desenvolvedores = display.newImage("imagens/desenvolvedor.png",display.actualContentWidth * 0.73, display.actualContentHeight * 0.78)
